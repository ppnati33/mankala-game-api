...
import com.mankalagameapi.model.Store;
...
public class GameServiceTest {
    ...
    @Test
    public void whenCreateGameThenNewlyCreatedContainsSevenPitsOwnedByEachPlayer() {
        // given
    ...
    @Test
    public void whenCreateGameThenNewlyCreatedGameContainsTwelveHousesWithSixStones() {
        // given
        Game game = createGame();
        when(gameStorageService.save(any())).thenReturn(game);
    ...
    @Test
    public void whenCreateGameThenNewlyCreatedContainsTwoStoresWithZeroStonesOneForEachPlayer() {
        // given
        Game game = createGame();
        when(gameStorageService.save(any())).thenReturn(game);
    ...
    @Test
    public void whenCreateGameThenNewlyCreatedContainsCorrectId() {
        // given
        Game game = createGame();
    ...
    @Test
    public void whenCreateGameThenNewlyCreatedContainsNoActivePlayer() {
        // given
        Game game = createGame();
        when(gameStorageService.save(any())).thenReturn(game);
